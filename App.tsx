...
const App: React.FC = () => {
  ...
  return (
    <div className="flex flex-col h-screen antialiased text-white bg-gray-900">
      ...
      <main className="flex-grow flex flex-col items-center justify-center">
        <div className="flex-1 flex items-center justify-center w-full">
          <div className="flex justify-center items-center w-full h-48 space-x-4 sm:space-x-6 px-4">
            {isLoading ? (
              <>
